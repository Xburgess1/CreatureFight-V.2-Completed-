...
public class Creature extends Actor
{
     ...
     * @param creatureType discusses the type that the creature has
     * @return an object of the Creature class
     */
    ...
    /**
     * there is nothing inside this method except for a comment
     * 
     * @param int idx 
    ...
    {
        //attacking is an empty method that will be overridden by subclasses
    }
    ...
    /**
     * String returns a type variable
     * 
     * @param None there are no paramters
     * @return a String that reprsents what type the creature has
     */
