...
public class CreatureWorld extends World
{
    ...
    public void act()
    {
        ...
        if(turnNumber == 0)
        {
            ...
            playerOneName = JOptionPane.showInputDialog(null, "Player one choose your name", "Username", JOptionPane.QUESTION_MESSAGE);
            ...
            playerTwoName = JOptionPane.showInputDialog(null, "Player two choose your name", "Username", JOptionPane.QUESTION_MESSAGE);
     ...
     * @return returns an integer that represents the turn number
     */
    ...
    /**
     * setTurnNumber sets turnNumber to equal turn
     * 
     * @param int turn is what player's turn it is
     * @return theere is no return
     */
